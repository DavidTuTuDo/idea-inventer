...
class ModularizedUpdateOrderRemarkOfAuthor extends BaseUpdateOrderRemarkOfAuthor {
    ...
    async handleHttpOnCall(data, session) {
        ...
        await this.validatePreciseOrderIsExist(detailOfPreciseOrder, data.idOfPreciseOrder, "UpdateOrderRemarkOfAuthor");

        /** 必須是買家才能更改備註 */
        await this.validateIsUserOfOrder(detailOfPreciseOrder, session, "UpdateOrderRemarkOfAuthor");
