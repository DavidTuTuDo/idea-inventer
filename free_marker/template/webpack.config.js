...
const self = {
    ...
    plugins: [
        ...
        new webpack.IgnorePlugin({
            resourceRegExp: /^\.\/.+/,
            contextRegExp: /pdf-parse|prompt|winston/
        }),
    ],
    target: ["web", 'es5'],
    resolve: {
...
if (process.env.typeOfEnv === 'prod') {
    ...
    self.devtool = enableSourceMap ? 'inline-source-map' : false;
