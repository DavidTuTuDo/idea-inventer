...
class InfinitePool {
    ...
    taskWrapper = (assignedTask, hashOfTask) => () => {
        ...
        let isAssignedTaskCompeleted = true;
    ...
    showState = () => {
        ...
        Util.appendInfo(this.getPoollerLogFormat(`executingQueue(正在執行的AsyncTask, 超過workerCount就是bug): ${this.executingTaskInQueue.length}`));
